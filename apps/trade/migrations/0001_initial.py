    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('waiting_pay', '待支付')], max_length=10, verbose_name='订单状态')),
                ...
                ('signer_name', models.CharField(default='', max_length=20, verbose_name='收货地址')),
